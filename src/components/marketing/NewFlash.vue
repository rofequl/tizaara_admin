  ...
  <div>
    ...
    <div class="row">
      <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
        ...
        <h3 class="page-title">Create New Flash Deals</h3>
      </div>
    </div>
    <!-- End Page Header -->
            ...
            <CForm @submit.prevent="create()" @keydown="form.onKeydown($event)">
              <c-row class="">
                ...
                <CCol md="9" class="mb-3 mb-xl-0">
                  <CInput v-model="$v.form.title.$model"
                          ...
                          :invalidFeedback="!$v.form.title.required?'Title Name required.': $v.form.title.maxLength?'':'Title Name not more than 255 character.' "
              ...
              <c-row class="my-3">
                ...
                <CCol md="9" class="mb-3 mb-xl-0">
                  ...
                  <br>
                  <span v-show="!$v.form.dateRange.required" class="danger">Select flash date range.</span>
                </CCol>
              </c-row>
              <c-row class="my-3">
                <CCol md="3" class="mb-3 mb-xl-0">
  ...
  methods: {
    ...
    onInputChange(e) {
      ...
      if (!files.type.match('image.*')) {
        alert(files.name + ' is not a image');
        return;
      }
    ...
    create() {
      ...
      this.form.post('flash-deals')
          .then(({data}) => {
            ...
            toast.fire({
              icon: 'success',
              title: 'Flash Deals Add successfully'
            });
