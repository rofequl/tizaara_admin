  ...
  <div>
    ...
    <div class="row">
      <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
        <span class="text-uppercase page-subtitle">Product Upload Manage
        </span>
        <h3 class="page-title">Colour</h3>
      </div>
      <div class="col-12 col-sm-6 d-flex align-items-center">
        <div class="mx-auto ml-sm-auto mr-sm-0">
          <CButton block color="info" @click="openModal">Add New Colour</CButton>
        </div>
      </div>
    </div>
    <!-- End Page Header -->
    ...
    <!-- Modal -->
    <b-modal id="adminModal" :title="editMode ? 'Colour Information Edit': 'New Colour Add'"
             hide-footer>
      <b-form @submit.prevent="editMode ? updateColor(): createColor()" @keydown="form.onKeydown($event)">
        <b-form-group>
          ...
          <b-form-invalid-feedback v-if="!$v.form.name.maxLength">
            Color name maximum 30 character.
          </b-form-invalid-feedback>
        ...
        <b-form-group>
          ...
          <b-form-invalid-feedback v-if="!$v.form.name.maxLength">
            Colour code maximum 10 character.
          </b-form-invalid-feedback>
          <has-error :form="form" field="name"></has-error>
        </b-form-group>
    ...
    updateColor() {
      ...
      this.form.put('color/' + this.form.id)
          .then((e) => {
            ...
            toast.fire({
              icon: 'success',
              title: 'Colour Update successfully'
            });
          })
          .catch((e) => {
        ...
        if (result.value) {
          this.form.delete('color/' + id)
              .then((data) => {
                ...
                toast.fire({
                  icon: 'success',
                  title: 'Colour deleted successfully'
                });
              })
              .catch(() => {
