<template>
  <div>
    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-6 d-flex align-items-center">
        <div class="mx-auto ml-sm-auto mr-sm-0">
          <CButton block color="info" @click="openModal">Add New Unit</CButton>
        </div>
      </div>
    </div>
    <!-- End Page Header -->
    ...
    <!-- Modal -->
    <b-modal id="adminModal" :title="editMode ? 'Unit Name Edit': 'New Unit Add'"
             hide-footer>
