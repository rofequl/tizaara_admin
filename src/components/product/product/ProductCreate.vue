        ...
        <CCardBody>
          <form-wizard @on-complete="formSubmit" title="Add New Products" subtitle="Insert product information"
            ...
            <tab-content title="Product Information" icon="ti-package"
              ...
              <div role="group" class="form-group form-row">
                <label class="col-form-label col-sm-3"> Select Subcategory : </label>
                <div class="col-sm-9">
              ...
              <div role="group" class="form-group form-row">
                <label class="col-form-label col-sm-3"> Select Sub Subcategory : </label>
                <div class="col-sm-9">
              ...
              <div role="group" class="form-group form-row">
                <label class="col-form-label col-sm-3"> Select Properties : </label>
                <div class="col-sm-9">
