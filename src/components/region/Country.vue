<template>
  <div>
    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-6 d-flex align-items-center">
        <div class="mx-auto ml-sm-auto mr-sm-0">
          <CButton block color="info" @click="openModal">Add New Country</CButton>
        </div>
      </div>
    </div>
    <!-- End Page Header -->
    ...
    <!-- Modal -->
    <b-modal id="adminModal" :title="editMode ? 'Country Information Edit': 'New Country Add'"
        ...
        <b-form-row>
          <b-col>
            ...
            <b-form-invalid-feedback v-if="!$v.form.name.maxLength">
              Country name maximum 100 character.
            </b-form-invalid-feedback>
          ...
          <b-col>
            ...
            <b-form-invalid-feedback v-if="!$v.form.code.maxLength">
              Country Code maximum 100 character.
            </b-form-invalid-feedback>
            <has-error :form="form" field="name"></has-error>
          </b-col>
        </b-form-row>
        <b-form-row class="my-2">
          <b-col>
            ...
            <b-form-invalid-feedback v-if="!$v.form.code_a3.maxLength">
              Country code_a3 maximum 100 character.
            </b-form-invalid-feedback>
            <has-error :form="form" field="name"></has-error>
          </b-col>
          <b-col>
            ...
            <b-form-invalid-feedback v-if="!$v.form.code_n3.maxLength">
              Country code_n3 maximum 200 character.
            </b-form-invalid-feedback>
            <has-error :form="form" field="name"></has-error>
          </b-col>
        </b-form-row>
