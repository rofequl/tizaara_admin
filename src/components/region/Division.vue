<template>
  <div>
    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-6 d-flex align-items-center">
        <div class="mx-auto ml-sm-auto mr-sm-0">
          <CButton block color="info" @click="openModal">Add New Division</CButton>
        </div>
      </div>
    </div>
    <!-- End Page Header -->
    ...
    <!-- Modal -->
    <b-modal id="adminModal" :title="editMode ? 'Division Information Edit': 'New Division Add'"
      ...
      <b-form @submit.prevent="editMode ? updateDivision(): createDivision()" @keydown="form.onKeydown($event)">
        <b-form-group>
          ...
          <b-form-invalid-feedback v-if="!$v.form.name.maxLength">
            Division name maximum 100 character.
          </b-form-invalid-feedback>
