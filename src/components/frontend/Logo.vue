  ...
  <div>
    ...
    <div class="row">
      <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
        ...
        <h3 class="page-title">Logo Settings</h3>
      </div>
    </div>
    <!-- End Page Header -->
          ...
          <CCard class="p-4">
            <CForm @submit.prevent="updateGeneral()" @keydown="form.onKeydown($event)">
              <CRow class="my-3">
                <CCol md="6">
                  <div role="group" class="d-flex justify-content-center">
                    <div class=""><label>Frontend logo :</label>
                ...
                <CCol md="6">
                  <div role="group" class="d-flex justify-content-center">
                    <div class=""><label>Admin logo :</label>
                      <vue-upload-multiple-image
              ...
              <CRow class="my-3">
                <CCol md="6">
                  <div role="group" class="d-flex justify-content-center">
                    <div class=""><label>Admin Login Background :</label>
                      <vue-upload-multiple-image
    ...
    updateGeneral: function () {
      ...
      this.form.put('general-settings-logo/' + this.form.id)
          .then((e) => {
            ...
            toast.fire({
              icon: 'success',
              title: 'Logo Settings update successfully'
            });
          })
          .catch((e) => {
            swal.fire("Failed!", 'There was something wrong.', 'warning');
